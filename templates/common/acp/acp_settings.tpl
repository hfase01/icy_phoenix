...
<tr>
	...
	<td class="row2" width="30%"><select name="ctracker_ipblock_logsize">{S_OUTPUT_2}</select></td>
</tr>
...
<tr>
	...
	<td class="row2" width="30%"><select name="ctracker_logsize_logins">{S_OUTPUT_9}</select></td>
</tr>
<tr>
...
<tr>
	...
	<td class="row2" width="30%"><select name="ctracker_login_ip_check">{S_OUTPUT_13}</select></td>
</tr>
...
<tr>
	...
	<td class="row2" width="30%"><select name="ctracker_spam_keyword_det">{S_OUTPUT_36}</select></td>
</tr>
...
<tr>
	...
	<td class="row2" width="30%"><select name="ctracker_massmail_time">{S_OUTPUT_30}</select></td>
</tr>
