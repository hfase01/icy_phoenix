...
<tr>
	...
	<td class="row2" style="width:350px;">
		...
		<input type="button" name="usersubmit" value="{L_FIND_USERNAME}" class="btn" onclick="window.open('{username_row.U_SEARCH_USER}', '_search', 'width=400,height=250,resizable=yes');" />
	</td>
</tr>
<!-- END username_row -->
<!-- BEGIN ip_row -->
