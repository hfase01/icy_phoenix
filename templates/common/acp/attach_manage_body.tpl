...
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACHMENT_IMG_PATH}</strong><br /><span class="gensmall">{L_IMG_PATH_EXPLAIN}</span></td>
	<td class="row2"><input type="text" size="25" maxlength="100" name="upload_img" class="post" value="{ATTACHMENT_IMG_PATH}" /></td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACHMENT_TOPIC_ICON}</strong><br /><span class="gensmall">{L_TOPIC_ICON_EXPLAIN}</span></td>
	<td class="row2"><input type="text" size="25" maxlength="100" name="topic_icon" class="post" value="{TOPIC_ICON}" /></td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_DISPLAY_ORDER}</strong><br /><span class="gensmall">{L_DISPLAY_ORDER_EXPLAIN}</span></td>
	<td class="row2">
	<table border=0 cellpadding=0 cellspacing=0>
		<tr><td><input type="radio" name="display_order" value="0" {DISPLAY_ORDER_DESC} /> {L_DESC}</td></tr>
		<tr><td><input type="radio" name="display_order" value="1" {DISPLAY_ORDER_ASC} /> {L_ASC}</td></tr>
	</table></td>
</tr>
<tr><th colspan="2">{L_ATTACHMENT_FILESIZE_SETTINGS}</th></tr>
<tr>
	<td class="row1" width="80%"><strong>{L_MAX_FILESIZE}</strong><br /><span class="gensmall">{L_MAX_FILESIZE_EXPLAIN}</span></td>
	<td class="row2"><input type="text" size="8" maxlength="15" name="max_filesize" class="post" value="{MAX_FILESIZE}" /> {S_FILESIZE}</td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACH_QUOTA}</strong><br /><span class="gensmall">{L_ATTACH_QUOTA_EXPLAIN}</span></td>
...
<tr>
	<td class="row1" width="80%"><strong>{L_MAX_FILESIZE_PM}</strong><br /><span class="gensmall">{L_MAX_FILESIZE_PM_EXPLAIN}</span></td>
...
<tr><th colspan="2">{L_ATTACHMENT_NUMBER_SETTINGS}</th></tr>
<tr>
	<td class="row1" width="80%"><strong>{L_MAX_ATTACHMENTS}</strong><br /><span class="gensmall">{L_MAX_ATTACHMENTS_EXPLAIN}</span></td>
	<td class="row2"><input type="text" size="3" maxlength="3" name="max_attachments" class="post" value="{MAX_ATTACHMENTS}" /></td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_MAX_ATTACHMENTS_PM}</strong><br /><span class="gensmall">{L_MAX_ATTACHMENTS_PM_EXPLAIN}</span></td>
...
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACHMENT_TOPIC_REVIEW}</strong><br /><span class="gensmall">{L_ATTACHMENT_TOPIC_REVIEW_EXPLAIN}</span></td>
...
<tr>
	<td class="row1" width="80%"><strong>{L_SHOW_APCP}</strong><br /><span class="gensmall">{L_SHOW_APCP_EXPLAIN}</span></td>
...
<!-- BEGIN switch_ftp -->
<tr>
	<td class="row1" width="80%"><strong>{L_FTP_UPLOAD}</strong><br /><span class="gensmall">{L_FTP_UPLOAD_EXPLAIN}</span></td>
...
<tr><th colspan="2">{L_ATTACHMENT_FTP_SETTINGS}</th></tr>
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACHMENT_FTP_SERVER}</strong><br /><span class="gensmall">{L_ATTACHMENT_FTP_SERVER_EXPLAIN}</span></td>
	<td class="row2"><input type="text" size="20" maxlength="100" name="ftp_server" class="post" value="{FTP_SERVER}" /></td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACHMENT_FTP_PATH}</strong><br /><span class="gensmall">{L_ATTACHMENT_FTP_PATH_EXPLAIN}</span></td>
	<td class="row2"><input type="text" size="20" maxlength="100" name="ftp_path" class="post" value="{FTP_PATH}" /></td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_DOWNLOAD_PATH}</strong><br /><span class="gensmall">{L_DOWNLOAD_PATH_EXPLAIN}</span></td>
	<td class="row2"><input type="text" size="20" maxlength="100" name="download_path" class="post" value="{DOWNLOAD_PATH}" /></td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_FTP_PASSIVE_MODE}</strong><br /><span class="gensmall">{L_FTP_PASSIVE_MODE_EXPLAIN}</span></td>
...
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACHMENT_FTP_USER}</strong></td>
	<td class="row2"><input type="text" size="20" maxlength="100" name="ftp_user" class="post" value="{FTP_USER}" /></td>
</tr>
<tr>
	<td class="row1" width="80%"><strong>{L_ATTACHMENT_FTP_PASS}</strong></td>
