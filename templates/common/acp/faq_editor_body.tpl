...
<!-- END questrow -->
<!-- BEGIN no_questions -->
<tr><td class="row1 row-center" colspan="5"><span class="gen">{L_NO_QUESTIONS}</span></td></tr>
<!-- END no_questions -->
<tr>
	<td class="row2" valign="top" colspan="5">
		<form method="post" action="{S_ACTION}" style="margin:0px;">
			<span class="gen">
				...
				<input class="btn" type="submit" value="{L_ADD_QUESTION}" name="submit" />
			</span>
		</form>
	</td>
</tr>
	...
	<td class="catLeft" colspan="5">
		<form method="post" action="{S_ACTION}" style="margin:0px;">
			<span class="gen">
				...
				<input class="btn" type="submit" value="{L_ADD_BLOCK}" name="submit" />
			</span>
		</form>
	</td>
</tr>
