...
<tr>
	<td class="cat" colspan="2" align="center"><input type="submit" name="submitted" value="{L_SUBMIT}" class="btn-primary" />&nbsp;&nbsp;<input type="reset" value="{L_RESET}" onclick="unsetChange();" class="btn" /></td>
</tr>
</form>
