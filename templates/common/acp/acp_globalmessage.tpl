...
<tr>
	...
	<td class="row1" width="80%" style="vertical-align:top;">
		...
		<tr>
			...
			<td width="60%" align="left" style="vertical-align:top;"><input type="radio" name="ctracker_global_message_type" onchange="change_field_desc(0)" value="1"{S_CHK_STATUS_1}>{L_MSG_TYPE_1} <input type="radio" name="ctracker_global_message_type" onchange="change_field_desc(1)" value="0"{S_CHK_STATUS_2}>{L_MSG_TYPE_2}</td>
		</tr>
		<tr>
			<td width="40%" align="right" style="vertical-align:top;"><b><span id="field_desc">{L_FIELD_DESC}</span> :</b></td>
			<td width="60%" align="left" style="vertical-align:top;"><textarea name="ctracker_global_message" maxlength="255" rows="10" cols="56">{S_CURRENT_TEXT}</textarea></td>
		</tr>
		</table>
	</td>
</tr>
