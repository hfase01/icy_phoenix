...
<tr>
	<td class="row1 row-center" valign="middle"><input type="text" size="30" maxlength="100" name="add_extension_explain" class="post" value="{ADD_EXTENSION_EXPLAIN}" /></td>
	<td class="row2 row-center" valign="middle"><input type="text" size="20" maxlength="100" name="add_extension" class="post" value="{ADD_EXTENSION}" /></td>
...
<tr>
	...
	<td class="row1 row-center" valign="middle"><input type="text" size="30" maxlength="100" name="extension_explain_list[]" class="post" value="{extension_row.EXTENSION_EXPLAIN}" /></td>
	<td class="row2 row-center" valign="middle"><b><span class="gen">{extension_row.EXTENSION}</span></b></td>
	<td class="row1 row-center" valign="middle">{extension_row.S_GROUP_SELECT}</td>
	<td class="row2 row-center" valign="middle"><input type="checkbox" name="extension_id_list[]" value="{extension_row.EXT_ID}" /></td>
</tr>
<!-- END extension_row -->
<tr>
