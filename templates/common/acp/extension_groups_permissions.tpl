...
<tr>
	<td align="center">
		...
		<tr>
			<td class="cat" align="center"> <input class="btn" type="submit" name="del_forum" value="{L_REMOVE_SELECTED}" /> &nbsp; <input class="btn" type="submit" name="close_perm" value="{L_CLOSE_WINDOW}" /><input type="hidden" name="e_mode" value="perm" /></td>
		</tr>
		</table>
		</form>
	</td>
...
<tr>
	<td>
		...
		<tr>
			<td class="cat" align="center"> <input type="submit" name="add_forum" value="{L_ADD_SELECTED}" class="mainoption" />&nbsp; <input type="reset" value="{L_RESET}" class="btn" />&nbsp; <input type="hidden" name="e_mode" value="perm" /></td>
		</tr>
		</table>
		</form>
	</td>
