...
<tr>
	<td width="50%" class="row1"><strong>{L_FIELD_NAME}</strong><br /><span class="gensmall">{L_FIELD_NAME_INFO}</span></td>
...
<!-- IF ORDER -->
<tr>
	<td width="50%" class="row1"><strong>{L_FIELD_ORDER}</strong></td>
