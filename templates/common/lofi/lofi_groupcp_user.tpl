...
<table width="100%" cellpadding="4" cellspacing="1" border="0" class="forumline">
	...
	<tr><th colspan="2" align="center" class="thHead" height="25">{L_GROUP_MEMBERSHIP_DETAILS}</th></tr>
	...
	<tr><th colspan="2" align="center" class="thHead" height="25">{L_JOIN_A_GROUP}</th></tr>
	<tr>
