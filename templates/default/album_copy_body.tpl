...
<tr><td class="row1 row-center"><br /><span class="gen">{L_COPY_TO_CATEGORY}</span>&nbsp;{S_CATEGORY_SELECT}&nbsp;<input class="btn-primary" type="submit" name="copy" value="{L_COPY}" /><br /></td></tr>
