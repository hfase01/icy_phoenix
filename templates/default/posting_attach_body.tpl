	...
	<tr>
		...
		<input type="submit" name="add_attachment_box" value="{L_ADD_ATTACHMENT_TITLE}" class="btn" />
	<!-- END show_apcp -->
		<!-- BEGIN switch_posted_attachments -->
			&nbsp; <input type="submit" name="posted_attachments_box" value="{L_POSTED_ATTACHMENTS}" class="btn" />
