...
<tr>
	<td width="100%" align="left" nowrap="nowrap">
		&nbsp;
		<select style="height: 29px;" name="ft" onchange="BBCft(); this.selectedIndex=0;" onmouseover="helpline('ft')">
		...
		&nbsp;
		<select style="height: 29px;" name="fs" onchange="BBCfs(); this.selectedIndex=0;" onmouseover="helpline('fs')">
		...
		&nbsp;
		<select style="height: 29px;" name="fc" onchange="BBCfc(); this.selectedIndex=0;" onmouseover="helpline('fc')">
...
<div id="helpbox" style="width: 550px; height: 29px; font-size: 10px; margin-bottom: 3px;" class="helpline">{L_STYLES_TIP}</div>
