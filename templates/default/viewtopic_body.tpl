...
<tr>
	<td align="left" valign="bottom">
		...
		<!-- IF S_THANKS --><span class="btn"><a href="{U_THANKS}"><img src="{THANKS_IMG}" alt="{L_THANKS}" title="{L_THANKS}" /></a></span><!-- ENDIF -->
		<!-- ELSE -->
		&nbsp;
		<!-- ENDIF -->
	</td>
...
<tr>
	<td align="left" valign="top">
		...
		<a class="btn" href="{U_POST_REPLY_TOPIC}" title="{L_POST_REPLY_TOPIC}" >{L_POST_REPLY_TOPIC}</a>
		<!-- IF S_THANKS --><span class="btn"><a href="{U_THANKS}"><img src="{THANKS_IMG}" alt="{L_THANKS}" title="{L_THANKS}" /></a></span>&nbsp;<!-- ENDIF -->
		<!-- IF S_CAN_REPLY --><span class="btn">{CA_QUICK_REPLY_BUTTON}</span>&nbsp;<!-- ENDIF -->
		<!-- ELSE -->
		&nbsp;
		<!-- ENDIF -->
	</td>
