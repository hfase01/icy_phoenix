...
<tr><td class="row1 row-center"><br /><span class="gen">{L_MOVE_TO_CATEGORY}</span> &nbsp; {S_CATEGORY_SELECT} &nbsp; <input class="btn-primary" type="submit" name="move" value="{L_MOVE}" /><br />&nbsp;</td></tr>
