...
//Contents for menu 1
var menu1 = new Array();
menu1[0] = '<br /><div class="center-block-text">&nbsp;<form action="{FULL_SITE_PATH}{U_SEARCH}" method="post"><input name="search_keywords" type="text" class="post" style="width: 150px;" />&nbsp;<input type="submit" class="btn" value="{L_SEARCH}" />&nbsp;<br /><\/form><\/div>';
...
<!-- ELSE -->
	<div class="navbar navbar-fixed-top">
		...
		<form class="pull-right navbar-search" action="{FULL_SITE_PATH}{U_SEARCH}" method="get">
		<input class="pull-right" type="text" name="search_keywords" size="20" onclick="if(this.value=='{L_SEARCH}')this.value='';" onblur="if(this.value=='')this.value='{L_SEARCH}';" value="{L_SEARCH}" />
		</form>
			</div><!--/.nav-collapse -->
		</div>
	</div>
