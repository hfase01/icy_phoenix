...
<tr>
	<td align="left" valign="top" nowrap="nowrap"><span class="btn"><a href="{U_POST_NEW_TOPIC}"><img src="{POST_IMG}" alt="{L_POST_NEW_TOPIC}" title="{L_POST_NEW_TOPIC}" /></a></span><br /></td>
