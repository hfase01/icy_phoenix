...
<tr>
	<td class="row1 row-center">
		...
		<span class="genmed">
			...
			<input class="btn-small" type="submit" name="search" value="{L_SEARCH}" />
		</span>
		...
		<span class="genmed" id="username_list" {USERNAME_LIST_VIS}>
			...
			{S_HIDDEN_FIELDS}
			<input type="submit" class="btn-small" onclick="refresh_username(this.form.username_list.options[this.form.username_list.selectedIndex].value); return false;" name="use" value="{L_SELECT}" />
		</span><br />
