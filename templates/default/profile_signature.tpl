...
<tr>
	...
	<td class="row2" width="530" align="middle">
		<input type="button" class="btn-small" value="{L_PROFILE}" onclick="location='{U_PROFILE}'">
		<input type="button" class="btn-small" value="{SIG_CURRENT}" onclick="location='{SIG_LINK}'">
		<input type="submit" class="btn-small" value="{SIG_PREVIEW}" name="preview">
		<input type="submit" class="btn" value="{SIG_SAVE}" name="save">
		<input type="submit" class="btn-small" value="{SIG_CANCEL}" name="cancel">
	</td>
</tr>
</table>{IMG_TFL}{IMG_TFC}{IMG_TFR}
</form>
