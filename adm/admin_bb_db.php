...
if ($mode == 'sql_change')
{
	if (!$action)
	{
		...
		echo '			<input type="submit" name="submit_it" value="'. $lang['db_submit_q'] .'" onclick="document.sql.submit()" class="btn" />';
...
echo '			<span class="genmed">';
echo '				<input type="submit" name="Optimize" value="'. $lang['db_optimize'] .'" onclick="document.mass.submit()" class="btn">';
echo '			</span>';
echo '		</td>';
echo '		<td class="row2 row-center">';
echo '			<span class="genmed">';
echo '				<input type="submit" name="Repair" value="'. $lang['db_repair'] .'" onclick="document.mass.submit()" class="btn">';
echo '			</span>';
echo '		</td>';
echo '		<td class="row2 row-center">';
echo '			<span class="genmed">';
echo '				<input type="submit" name="Truncate" value="'. $lang['db_truncate'] .'" onclick="document.mass.submit()" class="btn">';
echo '			</span>';
echo '		</td>';
echo '		<td class="row2 row-center">';
echo '			<span class="genmed">';
echo '				<input type="submit" name="Drop" value="'. $lang['db_drop'] .'" onclick="document.mass.submit()" class="btn">';
echo '			</span>';
echo '		</td>';
echo '	</tr>';
echo '</table>';
